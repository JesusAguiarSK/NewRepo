...
//The below will give us the place id. This is how it's fetched the ID
//per the google documentation (url as an example)
...
//Response of the fetch will look like this
...
//With the place ID, we can send a Place Details request:

    //https://maps.googleapis.com/maps/api/place/details/json?place_id=xxxxxx0&key=YOUR_API_KEY

//The response of the Place Details looks as below. From this we will extract the information
